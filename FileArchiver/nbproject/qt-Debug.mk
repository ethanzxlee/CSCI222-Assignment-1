...
<<<<<<< Updated upstream
# Generated by qmake (2.01a) (Qt 4.8.6) on: Thu Sep 17 18:39:02 2015
=======
# Generated by qmake (2.01a) (Qt 4.8.6) on: Fri Sep 18 00:29:39 2015
>>>>>>> Stashed changes
...
LINK          = g++
LFLAGS        = -m64
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu -Wl,-rpath,/usr/lib /usr/lib/libmysqlcppconn.so -lboost_iostreams -lboost_filesystem -lboost_system -lQtGui -lQtCore -lpthread 
AR            = ar cqs
RANLIB        = 
...
SOURCES       = FileArchiver.cpp \
		...
		helperFuncs.cpp \
		main.cpp \
		versionRec.cpp moc_MainWindow.cpp \
...
OBJECTS       = build/Debug/GNU-Linux-x86/FileArchiver.o \
		...
		build/Debug/GNU-Linux-x86/fileRecTestRun.o \
		build/Debug/GNU-Linux-x86/helperFuncs.o \
...
$(TARGET): ui_MainWindow.h ui_RetrieveForm.h $(OBJECTS)  
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) build/Debug/GNU-Linux-x86/FileArchiver1.0.0/ && $(COPY_FILE) --parents FileArchiver.h MainWindow.h MurMurHash3.h RetrieveForm.h TableModel.h fileRec.h helperFuncs.h ui_MainWindow.h ui_RetrieveForm.h versionRec.h build/Debug/GNU-Linux-x86/FileArchiver1.0.0/ && $(COPY_FILE) --parents FileArchiver.cpp MainWindow.cpp MurMurHash3.cpp RetrieveForm.cpp TableModel.cpp fileRec.cpp fileRecTestRun.cpp helperFuncs.cpp main.cpp versionRec.cpp build/Debug/GNU-Linux-x86/FileArchiver1.0.0/ && $(COPY_FILE) --parents MainWindow.ui RetrieveForm.ui build/Debug/GNU-Linux-x86/FileArchiver1.0.0/ && (cd `dirname build/Debug/GNU-Linux-x86/FileArchiver1.0.0` && $(TAR) FileArchiver1.0.0.tar FileArchiver1.0.0 && $(COMPRESS) FileArchiver1.0.0.tar) && $(MOVE) `dirname build/Debug/GNU-Linux-x86/FileArchiver1.0.0`/FileArchiver1.0.0.tar.gz . && $(DEL_FILE) -r build/Debug/GNU-Linux-x86/FileArchiver1.0.0
...
compiler_moc_header_make_all: moc_MainWindow.cpp moc_RetrieveForm.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_MainWindow.cpp moc_RetrieveForm.cpp
...
compiler_uic_make_all: ui_MainWindow.h ui_RetrieveForm.h
compiler_uic_clean:
	-$(DEL_FILE) ui_MainWindow.h ui_RetrieveForm.h
...
build/Debug/GNU-Linux-x86/fileRecTestRun.o: fileRecTestRun.cpp FileArchiver.h \
		fileRec.h \
		MurMurHash3.h \
		versionRec.h \
		helperFuncs.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/Debug/GNU-Linux-x86/fileRecTestRun.o fileRecTestRun.cpp

build/Debug/GNU-Linux-x86/helperFuncs.o: helperFuncs.cpp helperFuncs.h \
		MurMurHash3.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/Debug/GNU-Linux-x86/helperFuncs.o helperFuncs.cpp
