...
# Generated by qmake (2.01a) (Qt 4.8.6) on: Mon Aug 31 05:12:39 2015
...
LINK          = g++
LFLAGS        = -m64
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu -Wl,-rpath,/usr/lib /usr/lib/libmysqlcppconn.so -lQtGui -lQtCore -lpthread 
AR            = ar cqs
RANLIB        = 
...
SOURCES       = fileRec.cpp \
		fileRecTestRun.cpp \
		main.cpp 
OBJECTS       = build/Debug/GNU-Linux-x86/fileRec.o \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) build/Debug/GNU-Linux-x86/FileArchiver1.0.0/ && $(COPY_FILE) --parents fileRec.h md5.h build/Debug/GNU-Linux-x86/FileArchiver1.0.0/ && $(COPY_FILE) --parents fileRec.cpp fileRecTestRun.cpp main.cpp build/Debug/GNU-Linux-x86/FileArchiver1.0.0/ && (cd `dirname build/Debug/GNU-Linux-x86/FileArchiver1.0.0` && $(TAR) FileArchiver1.0.0.tar FileArchiver1.0.0 && $(COMPRESS) FileArchiver1.0.0.tar) && $(MOVE) `dirname build/Debug/GNU-Linux-x86/FileArchiver1.0.0`/FileArchiver1.0.0.tar.gz . && $(DEL_FILE) -r build/Debug/GNU-Linux-x86/FileArchiver1.0.0
